...
OM has a long history. In 2004, we published UnitDim, the precursor to OM. In 2009, OM 1.0 followed, of which versions up to [1.8](http://www.wurvoc.org/vocabularies/om-1.8/) have been created. Finally, in 2017, OM 2.0 followed which is still maintained today. In the future we will move to OM 3.0.
