...
OM is based on several official paper standards, such as [the Guide for the Use of the International System of Units](http://physics.nist.gov/cuu/pdf/sp811.pdf), by the NIST – a document that represents the SI as established by the the General Conference on Weights and Measures (CGPM) adapted to the United states, adapted back by us to the global standard (metre, litre, deca, tonne).
